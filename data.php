<?php
	 ...
	 $json->Sanremo[0]->monumento1 = "Concattedrale di Sanremo (5 km)";
   ...
   $json->Sanremo[0]->img_url1 = "Concattedrale.jpg";
   $json->Sanremo[3]->video_url="";
   $json->Sanremo[3]->Video = "";

   

   $json->Sanremo[1]->monumento2 = "Villa Nobel (12 km)";
   ...
   $json->Sanremo[1]->img_url2 = "VillaNobel.jpg";
   $json->Sanremo[3]->video_url="";
   $json->Sanremo[3]->Video = "";


   $json->Sanremo[2]->monumento3= "Santuario della Madonna della Costa (23 km)";
   ...
   $json->Sanremo[2]->img_url3 = "Concattedrale.jpg";
   $json->Sanremo[3]->video_url="";
   $json->Sanremo[3]->Video = "";

   
   $json->Sanremo[3]->monumento4 = "Video dei POI di  Sanremo"; 
   $json->Sanremo[2]->disp = "";
   $json->Sanremo[2]->desc = "";
   $json->Sanremo[2]->img_url = "";
